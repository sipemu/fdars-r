...
- [`shape.confidence.interval()`](https://sipemu.github.io/fdars-r/reference/shape.confidence.interval.md)
  : Bootstrap Confidence Bands for Elastic Karcher Mean
- [`bayesian.align.pair()`](https://sipemu.github.io/fdars-r/reference/bayesian.align.pair.md)
  : Bayesian Pairwise Curve Alignment
- [`elastic.align.pair.multires()`](https://sipemu.github.io/fdars-r/reference/elastic.align.pair.multires.md)
...
- [`elastic.partial.match()`](https://sipemu.github.io/fdars-r/reference/elastic.partial.match.md)
  : Elastic Partial Curve Matching
- [`curve.geodesic()`](https://sipemu.github.io/fdars-r/reference/curve.geodesic.md)
  : Geodesic Path Between Two Curves
- [`peak.persistence()`](https://sipemu.github.io/fdars-r/reference/peak.persistence.md)
  : Peak Persistence Analysis
- [`transfer.alignment()`](https://sipemu.github.io/fdars-r/reference/transfer.alignment.md)
...
- [`horiz.fpns()`](https://sipemu.github.io/fdars-r/reference/horiz.fpns.md)
...
- [`elastic_cut_dendrogram_rust()`](https://sipemu.github.io/fdars-r/reference/elastic_cut_dendrogram_rust.md)
...
- [`elastic_hierarchical_rust()`](https://sipemu.github.io/fdars-r/reference/elastic_hierarchical_rust.md)
  : Elastic hierarchical clustering
...
- [`elastic_kmeans_rust()`](https://sipemu.github.io/fdars-r/reference/elastic_kmeans_rust.md)
...
- [`elastic_spm_monitor_rust()`](https://sipemu.github.io/fdars-r/reference/elastic_spm_monitor_rust.md)
  : Elastic SPM Phase II monitoring.
- [`elastic_spm_phase1_rust()`](https://sipemu.github.io/fdars-r/reference/elastic_spm_phase1_rust.md)
  : Elastic SPM Phase I.
...
- [`smooth_basis_rust()`](https://sipemu.github.io/fdars-r/reference/smooth_basis_rust.md)
  ...
  penalty
- [`alignment_diagnose_pairwise_rust()`](https://sipemu.github.io/fdars-r/reference/alignment_diagnose_pairwise_rust.md)
  : Diagnose a single pairwise alignment
- [`alignment_diagnose_rust()`](https://sipemu.github.io/fdars-r/reference/alignment_diagnose_rust.md)
  : Diagnose alignment quality for all curves after Karcher mean
  computation
- [`alignment_elastic_pair_penalized_rust()`](https://sipemu.github.io/fdars-r/reference/alignment_elastic_pair_penalized_rust.md)
  : Penalized elastic alignment with configurable penalty type
- [`alignment_invert_warp_rust()`](https://sipemu.github.io/fdars-r/reference/alignment_invert_warp_rust.md)
  : Invert a warping function
- [`alignment_lambda_cv_rust()`](https://sipemu.github.io/fdars-r/reference/alignment_lambda_cv_rust.md)
  : Lambda cross-validation for elastic alignment regularisation
- [`alignment_orbit_representative_rust()`](https://sipemu.github.io/fdars-r/reference/alignment_orbit_representative_rust.md)
  : Compute the orbit representative of a curve in a quotient space
- [`alignment_phase_boxplot_rust()`](https://sipemu.github.io/fdars-r/reference/alignment_phase_boxplot_rust.md)
  : Phase boxplot for warping functions
- [`alignment_shape_distance_rust()`](https://sipemu.github.io/fdars-r/reference/alignment_shape_distance_rust.md)
  : Elastic shape distance between two curves
- [`alignment_shape_mean_rust()`](https://sipemu.github.io/fdars-r/reference/alignment_shape_mean_rust.md)
  : Shape mean (Karcher mean in quotient space)
- [`alignment_shape_self_distance_matrix_rust()`](https://sipemu.github.io/fdars-r/reference/alignment_shape_self_distance_matrix_rust.md)
  : Shape self-distance matrix
- [`alignment_warp_inverse_error_rust()`](https://sipemu.github.io/fdars-r/reference/alignment_warp_inverse_error_rust.md)
  : Warp inverse error: max \|gamma(gamma_inv(t)) - t\|
- [`alignment_warp_statistics_rust()`](https://sipemu.github.io/fdars-r/reference/alignment_warp_statistics_rust.md)
  : Warp statistics: mean, variance, confidence bands, Karcher mean warp
- [`basis2fdata_2d_rust()`](https://sipemu.github.io/fdars-r/reference/basis2fdata_2d_rust.md)
  : Reconstruct 2D functional data from tensor product basis
  coefficients (low-level)
...
- [`fclassif_qda_rust()`](https://sipemu.github.io/fdars-r/reference/fclassif_qda_rust.md)
  : QDA classification
- [`fdata2basis_2d_rust()`](https://sipemu.github.io/fdars-r/reference/fdata2basis_2d_rust.md)
...
- [`spm_amewma_monitor_rust()`](https://sipemu.github.io/fdars-r/reference/spm_amewma_monitor_rust.md)
  : Adaptive EWMA (AMEWMA) monitoring on sequential functional data.
- [`spm_arl0_ewma_t2_rust()`](https://sipemu.github.io/fdars-r/reference/spm_arl0_ewma_t2_rust.md)
  : In-control ARL for EWMA-T-squared chart.
- [`spm_arl0_spe_rust()`](https://sipemu.github.io/fdars-r/reference/spm_arl0_spe_rust.md)
  : In-control ARL for SPE chart.
- [`spm_arl0_t2_rust()`](https://sipemu.github.io/fdars-r/reference/spm_arl0_t2_rust.md)
  : In-control ARL for T-squared chart.
- [`spm_arl1_t2_rust()`](https://sipemu.github.io/fdars-r/reference/spm_arl1_t2_rust.md)
  : Out-of-control ARL for T-squared chart.
- [`spm_cusum_monitor_restart_rust()`](https://sipemu.github.io/fdars-r/reference/spm_cusum_monitor_restart_rust.md)
  : CUSUM monitoring with restart after each alarm.
- [`spm_cusum_monitor_rust()`](https://sipemu.github.io/fdars-r/reference/spm_cusum_monitor_rust.md)
  : CUSUM monitoring on sequential functional data.
- [`spm_evaluate_rules_rust()`](https://sipemu.github.io/fdars-r/reference/spm_evaluate_rules_rust.md)
...
- [`spm_ewma_rust()`](https://sipemu.github.io/fdars-r/reference/spm_ewma_rust.md)
  : EWMA-based SPM monitoring.
- [`spm_mewma_monitor_rust()`](https://sipemu.github.io/fdars-r/reference/spm_mewma_monitor_rust.md)
  : MEWMA monitoring on sequential functional data.
- [`spm_monitor_partial_batch_rust()`](https://sipemu.github.io/fdars-r/reference/spm_monitor_partial_batch_rust.md)
  : Monitor a batch of partially-observed curves.
- [`spm_monitor_partial_rust()`](https://sipemu.github.io/fdars-r/reference/spm_monitor_partial_rust.md)
...
- [`spm_phase1_iterative_rust()`](https://sipemu.github.io/fdars-r/reference/spm_phase1_iterative_rust.md)
  : Iterative Phase I chart construction.
- [`spm_phase1_rust()`](https://sipemu.github.io/fdars-r/reference/spm_phase1_rust.md)
  ...
  functional data.
- [`spm_profile_monitor_rust()`](https://sipemu.github.io/fdars-r/reference/spm_profile_monitor_rust.md)
  : Profile monitoring Phase II.
- [`spm_profile_phase1_rust()`](https://sipemu.github.io/fdars-r/reference/spm_profile_phase1_rust.md)
  : Profile monitoring Phase I.
- [`spm_select_ncomp_rust()`](https://sipemu.github.io/fdars-r/reference/spm_select_ncomp_rust.md)
...
- [`spm_spe_limit_robust_rust()`](https://sipemu.github.io/fdars-r/reference/spm_spe_limit_robust_rust.md)
...
- [`spm_t2_limit_robust_rust()`](https://sipemu.github.io/fdars-r/reference/spm_t2_limit_robust_rust.md)
  : Robust T-squared control limit.
- [`spm_t2_pc_contrib_rust()`](https://sipemu.github.io/fdars-r/reference/spm_t2_pc_contrib_rust.md)
...
- [`alignment_bayesian_pair()`](https://sipemu.github.io/fdars-r/reference/alignment_bayesian_pair.md)
  : Bayesian pairwise alignment via pCN MCMC on the Hilbert sphere
- [`alignment_closed_distance()`](https://sipemu.github.io/fdars-r/reference/alignment_closed_distance.md)
  : Elastic distance between two closed curves (optimizes over
  rotations)
- [`alignment_closed_pair()`](https://sipemu.github.io/fdars-r/reference/alignment_closed_pair.md)
...
- [`alignment_curve_geodesic()`](https://sipemu.github.io/fdars-r/reference/alignment_curve_geodesic.md)
...
- [`alignment_decomposition()`](https://sipemu.github.io/fdars-r/reference/alignment_decomposition.md)
  : Elastic phase-amplitude decomposition
- [`alignment_elastic_depth()`](https://sipemu.github.io/fdars-r/reference/alignment_elastic_depth.md)
...
- [`alignment_elastic_outlier()`](https://sipemu.github.io/fdars-r/reference/alignment_elastic_outlier.md)
...
- [`alignment_gauss_model()`](https://sipemu.github.io/fdars-r/reference/alignment_gauss_model.md)
  : Gaussian generative model: sample random curves from aligned data
- [`alignment_horiz_fpns()`](https://sipemu.github.io/fdars-r/reference/alignment_horiz_fpns.md)
  : Horizontal Functional Principal Nested Spheres (FPNS) for phase
  variability
- [`alignment_joint_gauss_model()`](https://sipemu.github.io/fdars-r/reference/alignment_joint_gauss_model.md)
  : Joint Gaussian generative model preserving amplitude-phase
  correlation
...
- [`alignment_karcher_mean_closed()`](https://sipemu.github.io/fdars-r/reference/alignment_karcher_mean_closed.md)
  : Karcher mean for closed (periodic) curves
- [`alignment_karcher_median()`](https://sipemu.github.io/fdars-r/reference/alignment_karcher_median.md)
  : Karcher median (Weiszfeld algorithm in elastic metric)
- [`alignment_multires_pair()`](https://sipemu.github.io/fdars-r/reference/alignment_multires_pair.md)
  : Multi-resolution elastic alignment (coarse DP + fine gradient
  refinement)
- [`alignment_pairwise_consistency()`](https://sipemu.github.io/fdars-r/reference/alignment_pairwise_consistency.md)
  : Pairwise alignment consistency
- [`alignment_partial_match()`](https://sipemu.github.io/fdars-r/reference/alignment_partial_match.md)
  : Elastic partial matching of a template within a longer target curve
- [`alignment_peak_persistence()`](https://sipemu.github.io/fdars-r/reference/alignment_peak_persistence.md)
...
- [`alignment_robust_karcher_mean()`](https://sipemu.github.io/fdars-r/reference/alignment_robust_karcher_mean.md)
...
- [`alignment_shape_ci()`](https://sipemu.github.io/fdars-r/reference/alignment_shape_ci.md)
...
- [`alignment_transfer()`](https://sipemu.github.io/fdars-r/reference/alignment_transfer.md)
