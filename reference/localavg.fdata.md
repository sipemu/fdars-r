...
- intervals:
  ...
  Optional matrix of custom intervals (2 columns: start, end). If
  provided, `n.intervals` is ignored.

## Value

A matrix with n rows (curves) and one column per interval, containing
