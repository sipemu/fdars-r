...
```{=html}
<img src="../reference/figures/streaming-depth-diagram.svg" alt="Streaming Depth: O(T log N) Per Query Curve" style="width:100%; max-width:700px;">
```
