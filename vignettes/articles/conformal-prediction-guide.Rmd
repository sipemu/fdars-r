...
**Use generic conformal when the model is already fitted** and you want to add
uncertainty quantification without re-training. This is common in production:
the model was trained once (possibly expensive), and you want prediction
intervals for new batches.
