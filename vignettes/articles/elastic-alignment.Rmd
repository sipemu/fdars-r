...
`elastic.align()` finds the optimal warping function $\gamma$ for each curve
using dynamic programming. The warping functions satisfy $\gamma(0) = 0$ and
$\gamma(1) = 1$ (boundary-preserving) and are monotone increasing (time never
runs backward).
