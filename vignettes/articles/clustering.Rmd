...
```{=html}
<img src="../reference/figures/clustering-diagram.svg" alt="Functional Clustering" style="width:100%; max-width:720px; display:block; margin:1em auto;" />
```
...
```{=html}
<img src="../reference/figures/clustering-kmeans-diagram.svg" alt="K-Means Clustering" style="width:100%; max-width:700px; display:block; margin:1em auto;" />
```
...
```{=html}
<img src="../reference/figures/clustering-fcm-diagram.svg" alt="Fuzzy C-Means Clustering" style="width:100%; max-width:700px; display:block; margin:1em auto;" />
```
