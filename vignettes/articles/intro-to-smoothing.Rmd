...
1. **Start with P-splines** - automatic $\lambda$ selection works well in most cases
2. **Use basis expansion** when you need derivatives (smoother derivatives)
3. **Use kernel smoothers** for highly irregular sampling or adaptive smoothing
