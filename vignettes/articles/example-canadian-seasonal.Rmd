...
| Spectral analysis | `lomb.scargle()`, `detect.periods()` | Annual (365 d) cycle and harmonics |
...
`detect.periods()` may also find harmonics (half-year, quarter-year) which
arise from the asymmetric shape of the temperature curve — the winter trough
is broader and flatter than the sharp summer peak.
...
- **Spectral analysis:** The Lomb-Scargle periodogram shows a strong 365-day
  peak; `detect.periods()` may also find harmonics from the asymmetric
  annual waveform.
