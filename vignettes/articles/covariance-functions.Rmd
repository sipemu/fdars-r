...
```{=html}
<img src="../reference/figures/covariance-kernels-diagram.svg" alt="Covariance Functions: Shape Controls Sample Path Smoothness" style="width:100%; max-width:700px;">
```
