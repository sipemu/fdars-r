...
```{=html}
<img src="../reference/figures/irregular-sampling-diagram.svg" alt="Irregular Functional Data Pipeline" style="width:100%; max-width:700px;">
```
...
For comprehensive coverage of basis functions, see `vignette("basis-representation", package = "fdars")`.
