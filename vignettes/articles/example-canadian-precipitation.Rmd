...
Longitude typically contributes more explanatory power for precipitation than
latitude, particularly in winter months when the Pacific moisture gradient
dominates. Combining both predictors yields the best fit. This contrasts with
temperature, where latitude is the dominant predictor.
...
- **Longitude dominates** for precipitation, reflecting the west-to-east
  ...
  peaks in winter.
- **Latitude plays a secondary role**, with higher-latitude stations tending
  to be drier overall.
