...
```{=html}
<img src="../reference/figures/simulation-toolbox-diagram.svg" alt="Karhunen-Loève Simulation Framework" style="width:100%; max-width:720px; display:block; margin:1em auto;" />
```
...
- `vignette("covariance-functions", package = "fdars")` — covariance kernels for simulation
- `vignette("irregular-sampling", package = "fdars")` — handling irregularly sampled data
