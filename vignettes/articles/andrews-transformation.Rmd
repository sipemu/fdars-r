...
```{=html}
<img src="../reference/figures/andrews-transformation-diagram.svg" alt="Andrews Transformation: From Tables to Curves" style="width:100%; max-width:720px; display:block; margin:1em auto;" />
```
