...
```{=html}
<img src="../reference/figures/cross-validation-diagram.svg" alt="Cross-Validation for Functional Data" style="width:100%; max-width:720px; display:block; margin:1em auto;" />
```
