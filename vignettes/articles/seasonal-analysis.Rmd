...
```{=html}
<img src="../reference/figures/seasonal-analysis-diagram.svg" alt="Seasonal Analysis Overview" style="width:100%; max-width:720px; display:block; margin:1em auto;" />
```

## Estimating Seasonal Period

```{=html}
<img src="../reference/figures/seasonal-period-diagram.svg" alt="Estimating Seasonal Period" style="width:100%; max-width:700px; display:block; margin:1em auto;" />
```
...
```{=html}
<img src="../reference/figures/seasonal-decompose-diagram.svg" alt="Handling Non-Stationary Data" style="width:100%; max-width:700px; display:block; margin:1em auto;" />
```
...
```{=html}
<img src="../reference/figures/seasonal-peaks-diagram.svg" alt="Peak Detection and Seasonal Strength" style="width:100%; max-width:700px; display:block; margin:1em auto;" />
```
...
```{=html}
<img src="../reference/figures/seasonal-change-diagram.svg" alt="Change Detection and Varying Period" style="width:100%; max-width:700px; display:block; margin:1em auto;" />
```
...
- `vignette("articles/example-canadian-seasonal")` — real-data example: Canadian
  temperature seasonal analysis with all detection and decomposition methods
- `vignette("working-with-derivatives", package = "fdars")` — estimating and analyzing functional derivatives
- `vignette("simulation-toolbox", package = "fdars")` — simulating functional data
