...
```{=html}
<img src="../reference/figures/introduction-diagram.svg" alt="The fdars Toolkit" style="width:100%; max-width:720px; display:block; margin:1em auto;" />
```
...
- `vignette("custom-plotting", package = "fdars")` — visualization and ggplot2 integration
