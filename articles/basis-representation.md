...
**Important:** Note that both curves are plotted on the **same scale**.
The B-spline basis achieves a substantially lower GCV score, confirming
it’s the better choice for this non-periodic signal with localized
features.
