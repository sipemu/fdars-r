...
head(depths_rp)
#> [1] 0.05741935 0.08645161 0.26451613 0.29612903 0.28193548 0.24774194
```
...
#> mode 0.98 1.00 0.95 0.15 0.97
#> RP   0.94 0.95 1.00 0.19 0.94
#> RT   0.13 0.15 0.19 1.00 0.15
#> FSD  0.98 0.97 0.94 0.15 1.00
```
