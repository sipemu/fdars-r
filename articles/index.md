...
- [Sonar: Mine vs Rock Classification via Elastic
  TSRVF](https://sipemu.github.io/fdars-r/articles/example-sonar-tsrvf.md):

### Learn

- [Introduction to
  fdars](https://sipemu.github.io/fdars-r/articles/introduction.md):
- [Custom Plotting with
  ggplot2](https://sipemu.github.io/fdars-r/articles/custom-plotting.md):
- [Introduction to Smoothing Functional
  Data](https://sipemu.github.io/fdars-r/articles/intro-to-smoothing.md):
- [Working with
  Derivatives](https://sipemu.github.io/fdars-r/articles/working-with-derivatives.md):
- [Simulating Functional
  Data](https://sipemu.github.io/fdars-r/articles/simulation-toolbox.md):
- [Working with Irregular Functional
  Data](https://sipemu.github.io/fdars-r/articles/irregular-sampling.md):
